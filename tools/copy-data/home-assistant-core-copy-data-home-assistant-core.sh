...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/noahbleau/ProxmoxVE-non-root/dev_modemain/tools/copy-data//home-assistant-core-copy-data-home-assistant-core.sh)"
