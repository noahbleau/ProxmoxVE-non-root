...
> [!IMPORTANT]
> **New scripts** must always be submitted to [ProxmoxVED](https://github.com/noahbleau/ProxmoxVE-non-root) first — not to this repository.
...
| :------------------------------------------ | :------------------------------------------------------------------------------------------- |
| **Add a brand-new script**                  | [ProxmoxVED](https://github.com/noahbleau/ProxmoxVE-non-root) — testing repo for new scripts |
...
| Report a bug or broken script               | [Open an Issue](https://github.com/noahbleau/ProxmoxVE-non-root/issues)                      |
| Request a new script or feature             | [Start a Discussion](https://github.com/noahbleau/ProxmoxVE-non-root/discussions)            |
...
1. Fork [ProxmoxVED](https://github.com/noahbleau/ProxmoxVE-non-root) and clone it
...
- PRs with **new scripts** opened against ProxmoxVE will be closed — submit them to [ProxmoxVED](https://github.com/noahbleau/ProxmoxVE-non-root) instead.
